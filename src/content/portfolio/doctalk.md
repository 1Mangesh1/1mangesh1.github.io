...
demo: "https://doctalk.mangeshbide.tech/docs"
featured: true
...
**Stack.** FastAPI (async) for the API, Cloudflare Workers AI for embeddings and generation, PyMuPDF for extraction, JWT for auth. I run it on Oracle Cloud's free ARM tier, containerized with Docker, provisioned with Terraform, deployed via GitHub Actions.
